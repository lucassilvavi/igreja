...
<table id="tb_membro" class="display table table-striped table-bordered table-fluid" style="width: 100%;">
    <thead>
        <tr>
            <th>Nome</th>
            <th>CPF</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="date"> {{\date_format($dados->dt_nascimento, "d/m/Y")}} </td>
            ...
            <td class="tamanho">
                <div class="btn-group">
                    ...
                    <button type="button" id="edtMembro" class="btn btn-primary btn-xs edtMembro"  value="{{$dados->id_membros}}">Editar</button>
                    <button type="button" class="btn btn-primary btn-xs disableMembro"  value="{{$dados->id_membros}}">Desativar</button>
                </div>
            </td>
        </tr>
        @endforeach
...
<script type="text/javascript" src="{{asset('assets/js/membro/modalDisableMembro.js')}}"></script>
